...
describe TeamsController do
  ...
  it { { delete:  'api/teams/1' }.should route_to(controller: "teams", action: "destroy", id: "1") }
  it { { get:  'api/teams/1/games' }.should route_to(controller: "teams", action: "games", id: "1") }
  it { { post: 'api/teams/1/add_player/2' }.should route_to(controller: "teams", action: "add_player", id: "1", player_id: "2") }
  it { { post: 'api/teams/1/remove_player/2' }.should route_to(controller: "teams", action: "remove_player", id: "1", player_id: "2") }
end
